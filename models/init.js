...
GameModel.belongsToMany(UserModel, { through: UserGameModel, as: "users", foreignKey: "game_id" });
UserModel.belongsToMany(GameModel, { through: UserGameModel, as: "games", foreignKey: "user_id" });
...
UserModel.hasMany(GameDetailsModel, { foreignKey: "user_id", as: "userGamesDetails" });
...
GameModel.hasMany(GameDetailsModel, { foreignKey: "game_id", as: "gameDetails" });
LeagueModel.hasMany(GameDetailsModel, { foreignKey: "league_id", as: "leagueGamesDetails" });
